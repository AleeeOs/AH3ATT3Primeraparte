 ...
 * @author Dell
 */
public class crear4 extends javax.swing.JFrame {

    /**
     * Creates new form crear4
     */
    public crear4() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(crear4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
