 ...
 * @author Dell
 */
public class crear3 extends javax.swing.JFrame {

    /**
     * Creates new form crear3
     */
    public crear3() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(crear3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
