 ...
 * @author Dell
 */
public class Actualizar4 extends javax.swing.JFrame {

    /**
     * Creates new form Actualizar4
     */
    public Actualizar4() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Actualizar4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Actualizar4().setVisible(true);
            }
        });
    }
